    ...
    <>
      ...
      <main className="fixed inset-0 h-screen w-screen overflow-hidden bg-black">
        <section className="h-screen w-screen overflow-hidden bg-black text-white">
          {fastFoodOpen ? (
            <div className="grid h-full w-full grid-cols-[360px_1fr] gap-3 p-3 font-[family-name:var(--font-caveat)]">
              <aside
              ...
              >
                ...
                <div className="flex flex-1 flex-col gap-5 px-5">
                  {promotions.map((promo) => (
                    <article key={promo.promotion_id} className="text-center">
              ...
              <section
                className="grid h-full w-full grid-cols-3 grid-rows-3 gap-x-6 gap-y-1 overflow-hidden px-8 py-4"
                style={{
                  backgroundImage: "url('/menu-bg.jpg')",
                  backgroundSize: "cover",
                  backgroundPosition: "center",
            ...
            <div
              className="flex h-full w-full items-center justify-center font-[family-name:var(--font-caveat)]"
              style={{
                backgroundImage: "url('/menu-bg.jpg')",
                backgroundSize: "cover",
                backgroundPosition: "center",
